...
class PulsedHeatingWidget(QtWidgets.QGroupBox):
    def __init__(self, *args, **kwargs):
        ...
        self._grid_layout.addWidget(self.stop_pulse_btn, 0, 2, 2, 3)
        ...
        self._grid_layout.addWidget(self.percent_lbl, 5, 2, 1, 3)
        self._grid_layout.addWidget(self.us_percent_display_le, 5, 5, 1, 2)
        self._grid_layout.addWidget(self.ds_width_le, 6, 0, 1, 2)
        self._grid_layout.addWidget(self.width_lbl, 6, 2, 1, 3)
        self._grid_layout.addWidget(self.us_width_le, 6, 5, 1, 2)
